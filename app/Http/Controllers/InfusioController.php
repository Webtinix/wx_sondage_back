...
class InfusioController extends Controller
{
    ...
    {   
        // dd(auth()->user()->id);
        // dd($class_tech_name, $instance_id);
        ...
        if($class_tech_name != null) {
            ...
            // $infusioJson['groupe_attributes']['formateur'] = $f;
            // dd($infusioJson['groupe_attributes']);
            return response()->json($infusioJson,Response::HTTP_OK);
        }
    }


    public function formation(Request $request, $company_uid ,  $lang_iso , $instance = null,$class_tech_name = 'formation' )
    {
        if (empty(auth()->user())) {
            # code...
    ...
    public function post(Request $request, $company_uid = null, $lang_iso = null,$class_tech_name = "formation" )
    {
        // if (empty(auth()->user())) {
        //     # code...
        //     return response()->json(['code' => 401, 'message' => 'Vous devez vous connecter' ],Response::HTTP_UNAUTHORIZED);
    ...
    public function put(Request $request , $company_uid, $lang_iso , $instance_id, $class_tech_name = 'formation' )
    {
        // dd($instance_id);
        $company = null;
            $lang = null;
